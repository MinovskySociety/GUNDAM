  ...
  class InnerVertex_ 
   ...
   private:
    ...
    protected:
      ...
      inline VertexPtrType VertexPtrContainerElement() const {
        assert(!this->IsDone());
    ...
    private:
      ...
      inline const VertexPtrIterator& const_vertex_ptr_iterator() const{
   ...
   public:
    ...
    class EdgePtrContent_<false, true, meaning_less_>
     ...
     private:
      ...
      inline VertexPtr VertexPtrContainerElement() const {
        assert(!this->IsNull());
    ...
    class EdgePtr_ : protected EdgePtrContent_<is_const_, !is_const_> {
     private:
      ...
      template <typename              ContainerType_,
                ...
                TupleIdxType            edge_id_idx_,
                TupleIdxType edge_attribute_ptr_idx_>
      using FriendEdgeContentIteratorSpecifiedEdgeLabelVertexPtr
                = EdgeContentIteratorSpecifiedEdgeLabelVertexPtr_<
                                                   ContainerType_,
                                                        is_const_,
                                                           depth_,
      ...
      template <typename              ContainerType_,
                ...
                TupleIdxType            edge_id_idx_,
                TupleIdxType edge_attribute_ptr_idx_>
      using FriendEdgeIteratorSpecifiedEdgeLabelVertexPtr
                    = Iterator_<FriendEdgeContentIteratorSpecifiedEdgeLabelVertexPtr<
                                                   ContainerType_,
                                                           depth_,
                                                     begin_depth_, 
                                                  edge_label_idx_,
      ...
      template <typename              ContainerType_,
                ...
                TupleIdxType edge_attribute_ptr_idx_>
      inline void Construct(
          const FriendEdgeIteratorSpecifiedEdgeLabelVertexPtr<
                                       ContainerType_, 
                                               depth_, 
                                         begin_depth_, 
                                      edge_label_idx_,
                                         ...
                                         edge_id_idx_, 
                              edge_attribute_ptr_idx_>& edge_iter) {
        using FriendEdgeContentIteratorSpecifiedEdgeLabelVertexPtrType
           =  FriendEdgeContentIteratorSpecifiedEdgeLabelVertexPtr<
                                            ContainerType_,
                                                    depth_, 
                                              begin_depth_, 
                                           edge_label_idx_,
        ...
        const FriendEdgeContentIteratorSpecifiedEdgeLabelVertexPtrType&
            edge_content_iter = *static_cast<
                const FriendEdgeContentIteratorSpecifiedEdgeLabelVertexPtrType*>(
                static_cast<const void*>(&edge_iter));
        ...
        this->vertex_ptr_iterator_ = edge_content_iter.const_vertex_ptr_iterator();
     ...
     public:
      ...
      template <typename              ContainerType_,
                ...
                TupleIdxType            edge_id_idx_,
                TupleIdxType edge_attribute_ptr_idx_>
      EdgePtr_(const FriendEdgeIteratorSpecifiedEdgeLabelVertexPtr<
                                            ContainerType_,
                                                    depth_, 
                                              begin_depth_, 
                                           edge_label_idx_,
   ...
   public:
    ...
    inline VertexConstIterator OutVertexBegin() const {
    ...
    inline VertexConstIteratorSpecifiedEdgeLabel OutVertexBegin(
        const EdgeLabelType& edge_label) const {
    ...
    inline VertexConstIterator InVertexBegin() const {
    ...
    inline VertexConstIteratorSpecifiedEdgeLabel InVertexBegin(
        const EdgeLabelType& edge_label) const {
...
//    }
  ...
  EdgeSizeType CountEdge() const {
    ...
    for (auto vertex_cit = this->VertexBegin();
