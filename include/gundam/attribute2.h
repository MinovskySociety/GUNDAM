...
enum class AttributeType : uint8_t {
  ...
  kGroupedSameType =
      2  /// a group of vertexes/edges shares the same key and value type
};

template <enum AttributeType attr_type, bool is_const_, typename GroupKeyType_,
          typename AttributeKeyType_, enum ContainerType container_type_,
          enum SortType sort_type_>
class Attribute_;

/// seperated attribute container
template <bool is_const_, typename GroupKeyType_, typename AttributeKeyType_,
          enum ContainerType container_type_, enum SortType sort_type_>
class Attribute_<AttributeType::kSeparated, is_const_, GroupKeyType_,
                 AttributeKeyType_, container_type_, sort_type_> {
 private:
  // Value
  class AbstractValue {
   public:
  ...
  template <typename _KeyType_, enum ContainerType _container_type_,
            enum SortType _sort_type_>
  using AttributeContainer = Container<_container_type_, _sort_type_, _KeyType_,
                                       AbstractValue*, enum BasicDataType>;

  // This"Ptr" is iterator!
  template <typename AttributeContainerType, bool _is_const_>
  class AttributeContentPtr_ {
   private:
    using IteratorType = typename std::conditional<
        _is_const_, typename AttributeContainerType::const_iterator,
   ...
   public:
    ...
    inline std::string value_str() const {
      assert(!this->is_null_);
      return this->iterator_.template get_const<kAttributeValuePtrIdx>()
          ->value_str();
    }
  ...
  class AttributePtr_
   ...
   private:
    ...
    using AttributeContentPtr =
        typename std::conditional<_is_const_, const AttributeContentPtrType*,
  ...
  template <typename _KeyType_, typename ContainerType_, bool _is_const_,
  ...
  class AttributeContentIterator_
   ...
   private:
    using InnerIteratorType =
        InnerIterator_<ContainerType_, _is_const_, depth_>;
   ...
   protected:
    ...
    using ContentPtr =
        typename std::conditional<_is_const_, const AttributeContentIterator_*,
   ...
   public:
    ...
    const _KeyType_& key() const {
      assert(!this->IsDone());
      return InnerIteratorType::template get_const<_KeyType_, key_idx_,
                                                   begin_depth_>();
    }
  ...
  using AttributeContentIterator =
      AttributeContentIterator_<AttributeKeyType_, AttributeContainerType,
                                false, 1, 0, kAttributeKeyIdx,
 ...
 public:
  ...
  using AttributeConstIterator = Iterator_<AttributeContentIterator_<
      AttributeKeyType_, AttributeContainerType, true, 1, 0, kAttributeKeyIdx,
      kAttributeValuePtrIdx, kAttributeValueTypeIdx>>;
  ...
  ~Attribute_() {
    for (auto it = this->attributes_.begin(); it != this->attributes_.end();
         it++)
...
template <bool attribute_is_const_, typename GroupKeyType_,
          typename AttributeKeyType_, enum ContainerType container_type_,
          enum SortType sort_type_>
class Attribute_<AttributeType::kGrouped, attribute_is_const_, GroupKeyType_,
                 AttributeKeyType_, container_type_, sort_type_> {
 private:
  ...
  using AttributeContainerGroupType =
      AttributeContainerGroup_<container_type_, sort_type_>;

  static constexpr TupleIdxType kGroupKeyIdx = 0;
  static constexpr TupleIdxType kAttributeContainerGroupPtrIdx = 1;
  using GroupContainerType =
      Container<container_type_, sort_type_, GroupKeyType_,
                AttributeContainerGroupType*>;

  using ContainerIDType =
      typename AttributeContainerGroupType ::ContainerIDType;
  ...
  class AttributeContainerGroup_ {
    ...
    using AttributeListType = AttributeList_;

    public : using ContainerIDType =
        typename AttributeListType::ContainerIDType;

    private : static constexpr TupleIdxType kAttributeKeyIdx = 0;
    static constexpr TupleIdxType kAttributeListPtrIdx = 1;
    using AttributeListPtrContainerType =
        Container<attribute_list_container_type_, attribute_list_sort_type_,
                  AttributeKeyType_, AttributeListType*>;
    ...
    class AttributeContentIterator_ :
        protected InnerIterator_<ContainerType_, is_const_, depth_>{
          private : using AttributeListPtr = AttributeListType*;
          using AttributeListConstPtr = const AttributeListType*;

          using InnerIteratorType =
              InnerIterator_<ContainerType_, is_const_, depth_>;
          ...
          inline AttributeListPtr attribute_list_ptr(){
              ...
              return InnerIteratorType::template get<
                  AttributeListPtr, attribute_list_ptr_idx_, depth_ - 1>();}
  ...
  inline bool HasValue() const {
    assert(!this->IsDone());
    return this->attribute_list_const_ptr()->HasValue(this->container_id_);
  }
 ...
 public:
  AttributeContentIterator_() : InnerIteratorType(), container_id_() {
    assert(this->IsDone());
    return;
  }
  ...
  AttributeContentIterator_(const ContainerIDType& container_id,
      ...
      : InnerIteratorType(parameters...), container_id_(container_id) {
...
inline const AttributeKeyType_& key() const {
  assert(!this->IsDone());
  return InnerIteratorType::template get_const<
      const AttributeKeyType_, attribute_key_idx_, depth_ - 1>();
}
...
template <typename ConcreteDataType, bool judge = is_const_,
          typename std::enable_if<!judge, bool>::type = false>
inline ConcreteDataType& value() {
  static_assert(judge == is_const_, "illegal usage of this method");
  assert(!this->IsDone());
  return this->attribute_list_ptr()->template value<ConcreteDataType>(
      this->container_id_);
}

inline std::string value_str() const {
  assert(!this->IsDone());
  return this->attribute_list_const_ptr()->value_str(this->container_id_);
}

inline BasicDataType value_type() const {
  assert(!this->IsDone());
  return this->attribute_list_const_ptr()->value_type(this->container_id_);
}

const char* value_type_name() const {
  assert(!this->IsDone());
  return this->attribute_list_const_ptr()->value_type_name(this->container_id_);
}
...
template <bool is_const_, TupleIdxType attribute_key_idx_,
          TupleIdxType attribute_list_ptr_idx_>
class AttributeContentPtr_ {
 private:
 ...
 protected:
  using AttributeListPtrContainerIteratorType = typename std::conditional<
      is_const_, typename AttributeListPtrContainerType::const_iterator,
 ...
 public:
  ...
  const char* value_type_name() const {
    assert(!this->IsNull());
    return this->attribute_list_const_ptr()->value_type_name(
        this->container_id_);
  }
...
template <bool is_const_, TupleIdxType attribute_key_idx_,
          TupleIdxType attribute_list_ptr_idx_>
class AttributePtr_
    : protected AttributeContentPtr_<is_const_, attribute_key_idx_,
                                     attribute_list_ptr_idx_> {
 private:
  using AttributeContentPtrType =
      AttributeContentPtr_<is_const_, attribute_key_idx_,
                           attribute_list_ptr_idx_>;

  using AttributeListPtrContainerIteratorType =
      typename AttributeContentPtrType ::AttributeListPtrContainerIteratorType;
  ...
  AttributePtr_() : AttributeContentPtrType() { return; }

  AttributePtr_(const ContainerIDType& container_id,
                const AttributeListPtrContainerIteratorType& iterator)
      : AttributeContentPtrType(container_id, iterator) {
    return;
  }
 ...
 public:
  ...
  using AttributePtr =
      AttributePtr_<false, kAttributeKeyIdx, kAttributeListPtrIdx>;
  using AttributeConstPtr =
      AttributePtr_<true, kAttributeKeyIdx, kAttributeListPtrIdx>;

  using AttributeIterator = Iterator_<
      AttributeContentIterator_<AttributeListPtrContainerType, false, 1,
                                kAttributeKeyIdx, kAttributeListPtrIdx>>;

  using AttributeConstIterator = Iterator_<
      AttributeContentIterator_<AttributeListPtrContainerType, true, 1,
                                kAttributeKeyIdx, kAttributeListPtrIdx>>;

  AttributeContainerGroup_() : container_id_counter_(0), top_container_id_(0) {
    return;
  }
...
class AttributeList_ {
 private:
  ...
  inline std::pair<AttributePtr, bool> AddAttribute(
      const ContainerIDType& container_id, const AttributeKeyType_& key,
      const ConcreteValueType& attribute_value) {
    /// <iterator, bool>
    auto ret = this->attribute_list_ptr_container_.Insert(key);
    if (ret.second) {
      /// does not have this key, new a new AttributeList for that key
      ret.first.template get<kAttributeListPtrIdx>() = new AttributeList_();
    }
    const bool kAddAttributeRet =
        ret.first.template get<kAttributeListPtrIdx>()->AddAttribute(
            container_id, attribute_value);
  ...
  class AbstractAttribute_ {
   public:
    ...
    AbstractAttribute_() { return; }

    virtual ~AbstractAttribute_() { return; }

    template <typename ConcreteValueType>
    inline ConcreteValueType& value() {
      auto temp_concrete_ptr =
          static_cast<ConcreteAttribute_<ConcreteValueType>*>(this);
    ...
    inline const ConcreteValueType& const_value() const {
      auto temp_concrete_ptr =
          static_cast<const ConcreteAttribute_<ConcreteValueType>*>(this);
    ...
    std::pair<AttributePtr, bool> SetAttribute(
      ...
      const bool kSetAttributeRet =
          ret.first.template get<kAttributeListPtrIdx>()->SetAttribute(
              container_id, value);
      return std::make_pair(AttributePtr(container_id, ret.first),
                            kSetAttributeRet);
    }
    ...
    inline size_t EraseAttribute(const ContainerIDType& container_id,
      ...
      ret.first.template get<kAttributeListPtrIdx>()->EraseAttribute(
          container_id);
      return 1;
    }
    ...
    inline ContainerIDType AllocID() {
      ...
      /// has free id now
      auto first_free_id_range_it = this->free_container_id_ranges_.begin();
      const ContainerIDType alloc_id = first_free_id_range_it->second;
      if (alloc_id > first_free_id_range_it->first) {
        ...
        assert(first_free_id_range_it->second >= first_free_id_range_it->first);
        return alloc_id;
      }
    ...
    inline bool Recycle(const ContainerIDType& container_id) {
      ...
      // iterator
      auto ge_it = this->free_container_id_ranges_.lower_bound(container_id);
      if (ge_it == this->free_container_id_ranges_.end()) {
        if (this->free_container_id_ranges_.empty()) {
          ...
          assert(this->container_id_counter_ == this->top_container_id_ - 1);
          this->free_container_id_ranges_.emplace(container_id, container_id);
          this->container_id_counter_--;
          return true;
        }
        ...
        this->free_container_id_ranges_.emplace_hint(lt_it, container_id,
                                                     container_id);
        this->container_id_counter_--;
        return true;
      }
      ...
      if (ge_it->first == container_id + 1) {
        ...
        if (ge_it != this->free_container_id_ranges_.begin()) {
          ...
          if (lt_it->second == container_id - 1) {
            ...
            /// iterator
            auto erase_lt_ret = this->free_container_id_ranges_.erase(lt_it);
            assert(erase_lt_ret == ge_it);
            auto erase_ge_ret = this->free_container_id_ranges_.erase(ge_it);
            this->free_container_id_ranges_.emplace_hint(
                erase_ge_ret, kLtBeginIdx, kGeEndIdx);
            this->container_id_counter_--;
            return true;
          }
        }
        ...
        /// iterator
        auto erase_ge_ret = this->free_container_id_ranges_.erase(ge_it);
        this->free_container_id_ranges_.emplace_hint(erase_ge_ret, container_id,
                                                     kGeEndIdx);
        this->container_id_counter_--;
        return true;
      }
      ...
      this->free_container_id_ranges_.emplace_hint(ge_it, container_id,
                                                   container_id);
      this->container_id_counter_--;
      return true;
    }
    ...
    inline size_t EraseContainer(const ContainerIDType& container_id) {
      ...
      for (auto it = this->attribute_list_ptr_container_.begin();
        ...
        it.template get<kAttributeListPtrIdx>()->EraseAttribute(container_id);
      }
      return 1;
    }
 ...
 public:
  ...
  using AttributeIterator =
      typename AttributeContainerGroupType ::AttributeIterator;
  using AttributeConstIterator =
      typename AttributeContainerGroupType ::AttributeConstIterator;

  /// pointer types
  using AttributePtr = typename AttributeContainerGroupType ::AttributePtr;
  using AttributeConstPtr =
      typename AttributeContainerGroupType ::AttributeConstPtr;
 ...
 private:
  inline void ExtendTo(const ContainerIDType& container_id) {
    ...
    this->attribute_container_id_ =
        this->attribute_container_group_ptr_->AllocID();
    // std::cout<<"allocated id: "<<this->attribute_container_id_<<std::endl;
    return;
  }

 public:
  AttributeList_() { return; }
  ...
  template <typename ConcreteDataType>
  inline ConcreteDataType& value(const ContainerIDType& container_id) {
  ...
  inline std::string value_str(const ContainerIDType& container_id) const {
    assert(this->HasValue(container_id));
  ...
  template <typename ConcreteDataType>
  inline std::pair<AttributePtr, bool> AddAttribute(
      const AttributeKeyType_& key, const ConcreteDataType& value) {
    return this->attribute_container_group_ptr_->AddAttribute(
...
AttributeContainerGroup_()
    : container_id_allocater_(0), container_id_counter_(0) {
  return;
}
...
inline const ConcreteValueType& const_attribute(
    const ContainerIDType& container_id, const AttributeKeyType_& key) const {
  /// <const_iterator, bool>
...
inline const BasicDataType attribute_value_type(
  ...
  return ret.first.template get_const<kAttributeListPtrIdx>()->value_type(
      container_id);
}

const char* attribute_value_type_name(const ContainerIDType& container_id,
                                      const AttributeKeyType_& key) const {
  return EnumToString(this->attribute_value_type(container_id, key));
}

inline AttributeIterator AttributeBegin(const ContainerIDType& container_id) {
...
inline AttributePtr FindAttributePtr(const ContainerIDType& container_id,
                                     const AttributeKeyType_& key) {
  /// <iterator, bool>
  auto ret = this->attribute_list_ptr_container_.Find(key);
  if (!ret.second) {
  ...
  const bool kAddAttributeRet =
      ret.first.template get<kAttributeListPtrIdx>()->FindAttributePtr(
          container_id);
  if (kAddAttributeRet) {
    /// has found
...
inline AttributeConstPtr FindConstAttributePtr(
  ...
  /// return the corresponds attribute ptr for that container_id
  const bool kAddAttributeRet =
      ret.first.template get_const<kAttributeListPtrIdx>()
...
template <typename ConcreteDataType>
std::pair<AttributePtr, bool> SetAttribute(const ContainerIDType& container_id,
                                           const AttributeKeyType_& key,
                                           const ConcreteDataType& value) {
  /// <iterator, bool>
  auto ret = this->attribute_list_ptr_container_.Find(key);
  ...
  ret.first.template get<kAttributeListPtrIdx>()->FindAttribute(container_id,
                                                                key);
  if (!ret.second) {
    /// already has this key, add a new value corresponds to
    /// container_id into it
    return ret.first.template get<kAttributeListPtrIdx>()->AddAttribute(
        container_id, value);
  }
  /// does not have this key, new a new AttributeList for that key
  ret.first.template get<kAttributeListPtrIdx>() = new AttributeList_();
...
inline size_t EraseAttribute(const ContainerIDType& container_id,
  ...
  assert(ret.second);  /// such a attribute list should have existed
  /// allows the attribute to be set as differet data type
  ret.first.template get<kAttributeListPtrIdx>()->EraseAttribute(container_id);
  return 1;
}
...
Attribute_(const GroupKeyType_& group_key) {
  ...
  /// <iterator, bool>
  auto ret =
      Attribute_::attribute_container_group_ptr_container_.Insert(group_key);
  if (ret.second) {
...
~Attribute_() {
  this->attribute_container_group_ptr_->EraseContainer(
      this->attribute_container_id_);
...
inline enum BasicDataType attribute_value_type(
    const AttributeKeyType_& key) const {
  return this->attribute_container_group_ptr_->attribute_value_type(
      this->attribute_container_id_, key);
}

inline const char* attribute_value_type_name(
    const AttributeKeyType_& key) const {
  return this->attribute_container_group_ptr_->attribute_value_type_name(
      this->attribute_container_id_, key);
}

inline AttributeIterator AttributeBegin() {
  return this->attribute_container_group_ptr_->AttributeBegin(
      this->attribute_container_id_);
}

inline AttributeConstIterator AttributeCBegin() const {
  return this->attribute_container_group_ptr_->AttributeCBegin(
      this->attribute_container_id_);
}

inline AttributePtr FindAttributePtr(const AttributeKeyType_& key) {
  return this->attribute_container_group_ptr_->FindAttributePtr(
      this->attribute_container_id_, key);
}

inline AttributeConstPtr FindConstAttributePtr(
    const AttributeKeyType_& key) const {
  return this->attribute_container_group_ptr_->FindConstAttributePtr(
      this->attribute_container_id_, key);
}
...
inline ConcreteDataType& attribute(const AttributeKeyType_& key) {
  return this->attribute_container_group_ptr_
      ->template attribute<ConcreteDataType>(this->attribute_container_id_,
                                             key);
}
...
inline std::pair<AttributePtr, bool> SetAttribute(
    const AttributeKeyType_& key, const ConcreteDataType& value) {
  return this->attribute_container_group_ptr_->SetAttribute(
      this->attribute_container_id_, key, value);
}
...
inline AttributeIterator EraseAttribute(
  ...
  /// pass this->attribute_container_id_ into group_ptr_container_ to check
  /// whether it is consist with teh container_id in attribute_iterator
  return this->attribute_container_group_ptr_->EraseAttribute(
...
//                 ret.first.template
//                 get<kAttributeValuePtrIdx>())->const_value();
...
//       this->attribute_container_id_
//           = ret.first.template
//           get<kAttributeContainerGroupPtrIdx>()->AllocID();
//       this->attribute_container_group_ptr_
//           = ret.first.template get<kAttributeContainerGroupPtrIdx>();
//       return;
//     }
...
//     for(auto it  =
//     Attribute_::attribute_container_group_ptr_container_.begin();
//              it != Attribute_::attribute_container_group_ptr_container_. end
//              (); it ++){
//       if (it.template get<kAttributeContainerGroupPtrIdx>()
//           == this->attribute_container_group_ptr_) {
...
//     return
//     Attribute_::attribute_container_group_ptr_container_.attribute_value_type(
//                  this->attribute_container_id_, key);
//   }

//   inline const char* attribute_value_type_name(const KeyType_& key) const {
//     return
//     Attribute_::attribute_container_group_ptr_container_.attribute_value_type_name(
//                  this->attribute_container_id_, key);
//   }

//   inline AttributeIterator AttributeBegin() {
//     return
//     Attribute_::attribute_container_group_ptr_container_.AttributeBegin(
//                            this->attribute_container_id_);
//   }

//   inline AttributeConstIterator AttributeCBegin() const {
//     return
//     Attribute_::attribute_container_group_ptr_container_.AttributeCBegin(
//                            this->attribute_container_id_);
//   }

//   inline AttributePtr FindAttributePtr(const KeyType_& key) {
//     return
//     Attribute_::attribute_container_group_ptr_container_.FindAttributePtr(
//                            this->attribute_container_id_, key);
//   }

//   inline AttributeConstPtr FindConstAttributePtr(const KeyType_& key) const {
//     return
//     Attribute_::attribute_container_group_ptr_container_.FindConstAttributePtr(
//                            this->attribute_container_id_, key);
//   }
...
//     return
//     Attribute_::attribute_container_group_ptr_container_.attribute<ConcreteDataType>(
//                            this->attribute_container_id_, key);
//   }
...
//       const std::string& value_str) {
//     return Attribute_::attribute_container_group_ptr_container_.AddAttribute(
//                            this->attribute_container_id_, data_type,
//                            value_str);
//   }
...
//     return
//     Attribute_::attribute_container_group_ptr_container_.EraseAttribute(
//                            this->attribute_container_id_,
//                            attribute_iterator);
//   }
