#ifndef _GUNDAM_TYPE_GETTER_VERTEX_ATTRIBUTE_HANDLE_H
#define _GUNDAM_TYPE_GETTER_VERTEX_ATTRIBUTE_HANDLE_H
...
#endif // _GUNDAM_TYPE_GETTER_VERTEX_ATTRIBUTE_HANDLE_H