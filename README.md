...
This separates *graph algorithms* from *graph data structures*, enabling the same algorithm to compile over different data structures without modification or runtime overhead.
