...
void TestGraphBase() {
  ...
  ASSERT_EQ(GUNDAM::GraphParameter<GUNDAM::GraphBase<GraphType>>::graph_level_vertex_label_index,
            GUNDAM::GraphParameter<                  GraphType >::graph_level_vertex_label_index);

  ASSERT_EQ(GUNDAM::GraphParameter<GUNDAM::GraphBase<GraphType>>::vertex_level_edge_label_index,
            GUNDAM::GraphParameter<                  GraphType >::vertex_level_edge_label_index);

  ASSERT_EQ(GUNDAM::GraphParameter<GUNDAM::GraphBase<GraphType>>::graph_level_vertex_label_index,
                            GUNDAM::GraphParameter<decltype(g1)>::graph_level_vertex_label_index);

  ASSERT_EQ(GUNDAM::GraphParameter<GUNDAM::GraphBase<GraphType>>::vertex_level_edge_label_index,
                            GUNDAM::GraphParameter<decltype(g1)>::vertex_level_edge_label_index);

  ASSERT_EQ(GUNDAM::GraphParameter<GUNDAM::GraphBase<GraphType>>::graph_level_vertex_label_index,
                      GUNDAM::GraphParameter<decltype(g1_const)>::graph_level_vertex_label_index);

  ASSERT_EQ(GUNDAM::GraphParameter<GUNDAM::GraphBase<GraphType>>::vertex_level_edge_label_index,
                      GUNDAM::GraphParameter<decltype(g1_const)>::vertex_level_edge_label_index);
