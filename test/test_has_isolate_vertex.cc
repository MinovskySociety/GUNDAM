...
void TestHasIsolateVertex(){
  ...
  ASSERT_FALSE(GUNDAM::HasIsolateVertex(g0));
  ...
  ASSERT_FALSE(GUNDAM::HasIsolateVertex(g1));
  ...
  ASSERT_TRUE(GUNDAM::HasIsolateVertex(g1));
  ...
  ASSERT_FALSE(GUNDAM::HasIsolateVertex(g2));
  return;
}

TEST(TestGUNDAM, TestHasIsolateVertex) {
  ...
  TestHasIsolateVertex<G1>();
  TestHasIsolateVertex<G2>();
  TestHasIsolateVertex<G3>();
  TestHasIsolateVertex<G4>();
  TestHasIsolateVertex<G5>();
  TestHasIsolateVertex<G6>();
  TestHasIsolateVertex<G7>();
}