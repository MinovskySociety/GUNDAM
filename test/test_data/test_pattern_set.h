...
template <class GraphType>
void ConstructGraph21(GraphType& g){
  // 1 -> 2 -> 4
  // ^     
  // |     
  // 3 
...
template <class GraphType>
void ConstructGraph22(GraphType& g){
  // 1 -> 2
  // ^    
  // |    
  // 3 <- 4
...
template <class GraphType>
void ConstructGraph23(GraphType& g){
  // 5 -> 1 <- 2 <- 4 <- 8
  //      ^           
  //      |          
  //      3 -> 6 -> 7   
